/**
 * Complete product data for Saucedemo inventory.
 * This file serves as the single source of truth for product details
 * to be used in catalog verification and checkout assertions.
 */
export const PRODUCTS = [
  {
    ...
    price: "29.99",
    imagePart: "sauce-labs-backpack-img",
    buttonPart: "add-to-cart-sauce-labs-backpack",
  },
  {
    ...
    price: "9.99",
    imagePart: "sauce-labs-bike-light-img",
    buttonPart: "add-to-cart-sauce-labs-bike-light",
  },
  {
    ...
    price: "15.99",
    imagePart: "sauce-labs-bolt-t-shirt-img",
    buttonPart: "add-to-cart-sauce-labs-bolt-t-shirt",
  },
  {
    ...
    price: "49.99",
    imagePart: "sauce-labs-fleece-jacket-img",
    buttonPart: "add-to-cart-sauce-labs-fleece-jacket",
  },
  {
    ...
    price: "7.99",
    imagePart: "sauce-labs-onesie-img",
    buttonPart: "add-to-cart-sauce-labs-onesie",
  },
  {
    ...
    price: "15.99",
    imagePart: "test.allthethings()-t-shirt-(red)-img",
    buttonPart: "add-to-cart-test.allthethings()-t-shirt-(red)",
  },
];
